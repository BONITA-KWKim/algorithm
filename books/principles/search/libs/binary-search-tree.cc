...
BSTNode *BinarySearchTree::create_node (int data) {
    BSTNode *node;
...
void BinarySearchTree::insert_node (BSTNode *head, BSTNode *node) {
...
void BinarySearchTree::remove_node (BSTNode *tree, int target) {
    if(NULL == tree) return;
...
void BinarySearchTree::destroy_node (BSTNode *node) {
    free(node);
}

void BinarySearchTree::destroy_tree (BSTNode *node) {
    if(NULL != node->right) {
...
BSTNode *BinarySearchTree::search_node(BSTNode *root, int target) {
...
BSTNode *BinarySearchTree::search_min_node(BSTNode *node) {
...
void BinarySearchTree::inorder_print_tree (BSTNode *node) {
    if (NULL == node) return;
...
void BinarySearchTree::inorder_print_tree (std::string *rst, BSTNode *node) {
    if (NULL == node) return;
